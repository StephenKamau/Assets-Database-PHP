    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                ...
                <a class="btn btn-danger mr-sm-2" href="viewresponsibility.php"><i class="fas fa-chevron-left"></i> Back to Records</a>
                <p></p>
                <?php
                $id = isset($_POST['search']) ? $_POST['search'] : "";

                echo "<div class='alert alert-success'>Showing results for user: " . $id . "</div>";
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        $query = "SELECT id,userid,startdate,description,enddate FROM responsibility WHERE userid=:userid";
