    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                ...
                <nav class="nav">
                    <li class="nav-item">
                        <a class="btn btn-primary mr-sm-2" href="createitem.php"><i class="fas fa-plus-circle"></i> Add Item</a>
                    </li>
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    $query = "SELECT id,name,value,description,expirydate FROM items ORDER BY id ASC";
                    ...
                    if ($num > 0) {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<td class='text-right'>Ksh$value</td>";
