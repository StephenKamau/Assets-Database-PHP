...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                ...
                <nav class="nav">
                    <li class="nav-item">
                        <a class="btn btn-primary mr-sm-2" href="createresponsibility.php"><i class="fas fa-plus-circle"></i> Add Responsibility</a>
                    </li>
                    <form class="form-inline my-2 my-lg-0" action="searchresponsibility.php" method="POST">
                        <input class="form-control mr-sm-2" type="search" placeholder="Search by User ID" aria-label="Search" name="search" required>
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    $query = "SELECT id,userid,startdate,enddate,description FROM responsibility ORDER BY id ASC";
                    ...
                    if ($num > 0) {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<a href='updateresponsibility.php?id={$id}' class='btn btn-primary btn-sm m-r-1em'>Edit</a>";
                            echo " ";
                            echo "<a href='#' onclick='delete_responsibility({$id});' class='btn btn-danger btn-sm m-r-1em'>Delete</a>";
                            echo "</td>";
                            echo "<tr>";
                            echo "</tbody>";
                        }
    ...
    function delete_responsibility( id ){
        
        var answer = confirm('Are you sure?');
        if (answer){
            // if user clicked ok, 
            // pass the id to delete.php and execute the delete query
            window.location = 'deleteresponsibility.php?id=' + id;
        } 
    }
    </script>
