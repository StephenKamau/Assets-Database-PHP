    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                ...
                <nav class="nav">
                    <li class="nav-item">
                        <a class="btn btn-primary mr-sm-2" href="createlocation.php"><i class="fas fa-plus-circle"></i> Add Location</a>
                    </li>
                    <form class="form-inline my-2 my-lg-0" action="searchlocation.php" method="POST">
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    $query = "SELECT id,name,description FROM locations ORDER BY id ASC";
