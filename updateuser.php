        ...
        <div class="row">
            <div class="col-md bg-l d">
                ...
                if ($_POST) {
                    try {
                        //update query
                        $query = "UPDATE user SET firstname=:firstname,lastname=:lastname,emailaddress=:emailaddress,idnumber=:idnumber,dateofbirth=:dateofbirth,gender=:gender,phone=:phone WHERE id=:id";
