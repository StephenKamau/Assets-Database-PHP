    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                <h2 class="title">Edit Responsibility</h2>
                <a class="btn btn-danger" href="viewresponsibility.php"><i class='fas fa-chevron-left'></i> Back to Records</a>
                <p></p>
                ...
                try {
                    ...
                    $query = "SELECT id,userid,startdate,description,enddate FROM responsibility WHERE id = ? LIMIT 0,1";
                ...
                if ($_POST) {
                    try {
                        //update query
                        $query = "UPDATE responsibility SET userid=:userid,startdate=:startdate,description=:description,enddate=:enddate WHERE id=:id";
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="userid" id="userid" value="<?php echo htmlspecialchars($userid, ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="startdate" id="startdate" value="<?php echo htmlspecialchars($startdate, ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="enddate">End Date:</label>
                                <input type="date" class="form-control" name="enddate" id="enddate" value="<?php echo htmlspecialchars($enddate, ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
