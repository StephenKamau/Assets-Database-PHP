        ...
        <div class="row">
            <div class="col-md bg-l d">
                ...
                try {
                    ...
                    $query = "SELECT id,name,value,description,expirydate FROM items WHERE id = ? LIMIT 0,1";
                ...
                if ($_POST) {
                    try {
                        //update query
                        $query = "UPDATE items SET name=:name,value=:value,description=:description,expirydate=:expirydate WHERE id=:id";
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="value" id="value" value="<?php echo htmlspecialchars($value, ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="expirydate" id="expirydate" value="<?php echo htmlspecialchars($expirydate, ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
