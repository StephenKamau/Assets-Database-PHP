...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md bg-l d">
                ...
                <a class="btn btn-danger mr-sm-2" href="viewlocations.php"><i class="fas fa-chevron-left"></i> Back to Records</a>
                <p></p>
                <?php
                $id = isset($_POST['search']) ? $_POST['search'] : "";

                echo "<div class='alert alert-success'>Showing results for location: #" . $id . "</div>";
                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        $query = "SELECT name,description FROM locations WHERE id=:id";
                        ...
                        if ($num > 0) {
                            ...
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                echo "<a href='updatelocation.php?id={$id}' class='btn btn-primary btn-sm m-r-1em'>Edit</a>";
                                echo " ";
                                echo "<a href='#' onclick='delete_location({$id});' class='btn btn-danger btn-sm m-r-1em'>Delete</a>";
                                echo "</td>";
                                echo "<tr>";
                                echo "</tbody>";
                            }
    ...
    function delete_location( id ){
        ...
        if (answer){
            ...
            window.location = 'deletelocation.php?id=' + id;
        } 
    }
    </script>
